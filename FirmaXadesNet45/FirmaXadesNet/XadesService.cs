...
namespace FirmaXadesNet
{
    ...
    public class XadesService
    {
        ...
        public SignatureDocument CounterSign(SignatureDocument sigDocument, SignatureParameters parameters)
        {
            ...
            keyInfo.Id = counterSignature.Signature.Id + "-KeyInfo";
            ...
            referenceKeyInfo.Uri = "#" + counterSignature.Signature.Id + "-KeyInfo";
            referenceKeyInfo.DigestMethod = parameters.DigestMethod.URI;
            ...
            counterSignatureXadesObject.QualifyingProperties.SignedProperties.Id = "xmldsig-" + counterSignature.Signature.Id + "-signedprops";
        ...
        private void AddXadesInfo(SignatureDocument sigDocument, SignatureParameters parameters)
        {
            ...
            xadesObject.QualifyingProperties.SignedProperties.Id = "xmldsig-" + sigDocument.XadesSignature.Signature.Id + "-signedprops";
        ...
        private void AddCertificateInfo(SignatureDocument sigDocument, SignatureParameters parameters)
        {
            ...
            KeyInfo keyInfo = new KeyInfo();
            keyInfo.Id = sigDocument.XadesSignature.Signature.Id + "-KeyInfo";
            ...
            reference.Uri = "#" + sigDocument.XadesSignature.Signature.Id + "-KeyInfo";
